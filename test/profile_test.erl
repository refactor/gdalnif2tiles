...
geo_query_geodetic_test() ->
    ...
    {RB,WB} = global_profile:geo_query(RasterInfo, TileBounds),
...
geo_query_mercator_test() ->
    ...
    Profile0 = global_profile:init(mercator),
    Profile = global_profile:new_tile_job(Profile0, RasterInfo),
    TileBounds = {-11114555.408890909, 3913575.8482010253, -11036283.891926888, 3991847.3651650436},
    {RB,WB} = global_profile:geo_query(RasterInfo, TileBounds),
    ExpectedRB = {0, 0, 49, 230},
    ExpectedWB = {224, 43, 49, 230},
    ?assertEqual(ExpectedRB, RB),
    ?assertEqual(ExpectedWB, WB).
